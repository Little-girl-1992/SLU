...
class Keras_MAC(object):
    def __init__(self):
        ...
        self.nb_epoch = 1000
        self.lr = 0.0001
        self.loss_path = TEXT_DATA_DIR + 'loss_no_gate_1000.png'
        self.old_model = ''
        self.new_model = TEXT_DATA_DIR + 'model_no_gate_1000.h5'
...
if __name__ == '__main__':
    ...
    # keras_mac.valid_rnn(valid_data_g, dtype='all')
    # keras_mac.test_rnn(valid_data_g)
