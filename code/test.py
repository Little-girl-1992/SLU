...
def train_rnn(train_data, valid_data, embedding_matrix, save_path=''):
    ...
    p3 = p_layer([rnn_l, rnn_r3])
    p4 = p_layer([rnn_l, rnn_r4])
    p5 = p_layer([rnn_l, rnn_r5])

    h1 = Multiply()([p1, rnn_r1])
    h2 = Multiply()([p2, rnn_r2])
    h3 = Multiply()([p3, rnn_r3])
    h4 = Multiply()([p4, rnn_r4])
    h5 = Multiply()([p5, rnn_r5])

    h = Add()([h1, h2, h3, h4, h5])
...
def p_rnn(valid_data, save_path=''):
    model = load_model(save_path + 'model_01.h5')
    valid_x, valid_m, valid_y = valid_data

    intermediate_layer_model1 = Model([model.get_layer('main_input').input, model.get_layer('aux_input1').input],
                                      model.get_layer('att').get_output_at(0))
    intermediate_layer_model2 = Model([model.get_layer('main_input').input, model.get_layer('aux_input2').input],
                                      model.get_layer('att').get_output_at(1))
    intermediate_layer_model3 = Model([model.get_layer('main_input').input, model.get_layer('aux_input3').input],
                                      model.get_layer('att').get_output_at(2))
    intermediate_layer_model4 = Model([model.get_layer('main_input').input, model.get_layer('aux_input4').input],
                                      model.get_layer('att').get_output_at(3))
    intermediate_layer_model5 = Model([model.get_layer('main_input').input, model.get_layer('aux_input5').input],
                                      model.get_layer('att').get_output_at(4))

    intermediate_layer_model6 = Model([model.get_layer('main_input').input,
    ...
    while True:
        ...
        intermediate_output1 = intermediate_layer_model1.predict([valid_x[index], valid_m[0][index]])
        intermediate_output2 = intermediate_layer_model2.predict([valid_x[index], valid_m[1][index]])
        intermediate_output3 = intermediate_layer_model3.predict([valid_x[index], valid_m[2][index]])
        intermediate_output4 = intermediate_layer_model4.predict([valid_x[index], valid_m[3][index]])
        intermediate_output5 = intermediate_layer_model5.predict([valid_x[index], valid_m[4][index]])
        intermediate_output6 = intermediate_layer_model6.predict([valid_x[index],
                                                                 valid_m[0][index],
                                                                 valid_m[1][index],
                                                                 valid_m[2][index],
                                                                 valid_m[3][index],
        ...
        for i in range(len(index)):
            print('1:', intermediate_output1[i])
            print('2:', intermediate_output2[i])
            print('3:', intermediate_output3[i])
            print('4:', intermediate_output4[i])
            print('5:', intermediate_output5[i])
            print('a:', intermediate_output6[i])

        print('a:::::', intermediate_output6)
...
if __name__ == '__main__':
    ...
    p_rnn(train_data_g, save_path=TEXT_DATA_DIR)
